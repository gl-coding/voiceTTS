...
def train(appid, token, audio_path, spk_id):
    ...
    audios = [{"audio_bytes": encoded_data, "audio_format": "mp3"}]
...
if __name__ == "__main__":
    appid = "3384563591"
    token = "UpTwYTHp5ULW0WAOTYazIQ_0q9E1n4Et"
    spk_id = "S_77fGW2Os1"
    train(appid=appid, token=token, audio_path="dushunv2.MP3", spk_id=spk_id)
